...
public class Activator implements BundleActivator {
    ...
    // GET http://127.0.0.1:8080/om2m/nscl/discovery
    private static void discoverResources() {
        ...
        //String base = Constants.CORE_PROTOCOL+"://" + Constants.CORE_IP + ":" + Constants.CORE_PORT + Constants.SCL_CONTEXT + "/";
    ...
    */
    public static void registerScl() {
        ...
        System.out.println("----------------------------------------------------------------------------------");
        System.out.println();
        System.out.println(pocs.getReference());
        System.out.println();
        System.out.println();
        ...
        System.out.println();
        System.out.println();
        System.out.println(requestIndication);
        System.out.println();
        System.out.println("----------------------------------------------------------------------------------");
