...
public class Constants {
    ...
    /** SclBase ip address. */
    public static final String SCL_IP = System.getProperty("org.eclipse.om2m.sclBaseAddress","127.0.0.1"); /*127.0.0.1*/
    
    
    
    
    /** SclBase listening port. */
    public static final int SCL_PORT = Integer.parseInt(System.getProperty("org.eclipse.equinox.http.jetty.https.port","8080")); /*org.eclipse.equinox.http.jetty.http.port , 8080*/
    ...
    public static final String CORE_PROTOCOL = "http";
    public static final String CORE_IP = "127.0.0.1";
    public static final int CORE_PORT = Integer.parseInt(System.getProperty("org.eclipse.equinox.http.jetty.http.port","8080"));
}