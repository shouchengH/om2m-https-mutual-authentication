...
public class Activator implements BundleActivator {
    ...
    public static final String HTTPS_ENABLE = System.getProperty("org.eclipse.equinox.http.jetty.https.enabled", null);
    ...
    public void start(BundleContext bundleContext) throws Exception {
      ...
      //  if (HTTPS_ENABLE == "true"){
       // 	System.out.println("555555555555555555555555555");
        	bundleContext.registerService(RestClientService.class.getName(), new RestHttpsClient(), null);
      //  }
       // else{
