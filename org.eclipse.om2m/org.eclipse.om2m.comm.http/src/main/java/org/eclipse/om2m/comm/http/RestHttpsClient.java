...
public class RestHttpsClient implements RestClientService {
    ...
    */
    public ResponseConfirm sendRequest(RequestIndication requestIndication) {
        ...
        Protocol.registerProtocol(protocol , new Protocol(protocol, fcty, 443));
